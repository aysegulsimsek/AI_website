      ...
      >
        <div className="container relative" ref={parallaxRef}>
          <div className="relative z-1 max-w-[62rem] mx-auto text-center mb-[4rem] md:mb-20 lg:mb-[6rem]">
            ...
            <div className="relative mt-12 max-w-[23rem] mx-auto md:max-w-5xl xl:mb-24">
              ...
              <div className="absolute -top-[54%] left-1/2 w-[234%] -translate-x-1/2 -z-3 md:-top-[46%] md:w-[138%] lg:-top-[104%] ">
                <img
                  src={heroBackground}
                  alt="hero"
